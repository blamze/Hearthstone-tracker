...
router.get('/', function (req, res) {
  db.any("SELECT classes.name AS FirstClass , classes.name AS SecondClass FROM matches LEFT JOIN classes ON (matches.fclass=classes.id) AND (matches.sclass=classes.id) ", [])
